        ...
        public static void Initialize(CentralAPIContext context)
        {
            ...
            var PaymentMethods = new PaymentMethod[]
           {
            ...
            var users = new User[]
            {
                    ...
                    new User{Id="5",UserName= "SergioP", NormalizedUserName = "SERGIO", name="Sergio Pinto", PasswordHash="AQAAAAEAACcQAAAAEN8nPp9f0odLuars7cGuvSUur2ZUZ5Z8to6gFZMo0S2vnArvzBWeBsIv6XowV9tLYQ==", Email= "sergio.valente.pinto@gmail.com", NormalizedEmail = "SERGIO.VALENTE.PINTO@GMAIL.COM" ,nif= "555555555", paymentMethodID = "1"},

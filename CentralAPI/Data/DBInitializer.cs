    ...
    public class DBInitializer
    {
        public static void Initialize(CentralAPIContext context)
        {
            ...
            var PaymentMethods = new PaymentMethod[]
           {
            ...
            var users = new User[]
            {
                    new User{Id="1", UserName="MarianaG", NormalizedUserName = "MARIANAG", name="Mariana Gomes", PasswordHash="AQAAAAEAACcQAAAAEN8nPp9f0odLuars7cGuvSUur2ZUZ5Z8to6gFZMo0S2vnArvzBWeBsIv6XowV9tLYQ==", Email="marianaribgomes@gmail.com", NormalizedEmail="MARIANARIBGOMES@GMAIL.COM", nif="111111111", paymentMethodID = "1"},
                    new User{Id="2", UserName= "TiagoA", NormalizedUserName = "TIAGOA", name="Tiago Azevedo", PasswordHash="AQAAAAEAACcQAAAAEN8nPp9f0odLuars7cGuvSUur2ZUZ5Z8to6gFZMo0S2vnArvzBWeBsIv6XowV9tLYQ==", Email="tiagomina.azevedo@gmail.com", NormalizedEmail = "TIAGOMINA.AZEVEDO@GMAIL.COM", nif="222222222", paymentMethodID = "1"},
                    new User{Id="3", UserName= "JoaoM", NormalizedUserName = "JOAOM", name="João Martins", PasswordHash="AQAAAAEAACcQAAAAEN8nPp9f0odLuars7cGuvSUur2ZUZ5Z8to6gFZMo0S2vnArvzBWeBsIv6XowV9tLYQ==", Email="joaom.vodafone@gmail.com",NormalizedEmail = "JOAOM.VODAFONE@GMAIL.COM",nif="333333333", paymentMethodID = "2"},
                    new User{Id="4", UserName= "CaioR", NormalizedUserName = "CAIOR", name="Caio Reis", PasswordHash="AQAAAAEAACcQAAAAEN8nPp9f0odLuars7cGuvSUur2ZUZ5Z8to6gFZMo0S2vnArvzBWeBsIv6XowV9tLYQ==", Email= "caiocruzeiror@gmail.com", NormalizedEmail = "CAIOCRUZEIROR@GMAIL.COM", nif= "444444444", paymentMethodID = "1"},
                    new User{Id="5",UserName= "SergioP", NormalizedUserName = "SERGIOP", name="Sergio Pinto", PasswordHash="AQAAAAEAACcQAAAAEN8nPp9f0odLuars7cGuvSUur2ZUZ5Z8to6gFZMo0S2vnArvzBWeBsIv6XowV9tLYQ==", Email= "sergio.valente.pinto@gmail.com", NormalizedEmail = "SERGIO.VALENTE.PINTO@GMAIL.COM" ,nif= "555555555", paymentMethodID = "1"},
